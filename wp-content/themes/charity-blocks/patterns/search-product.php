 ...
 * Slug: charity-blocks/search-product
 * Categories: charity-blocks, search-product
 */
?>
...
<!-- wp:paragraph -->
<p><?php esc_html_e('No products were found matching your selection.','charity-blocks'); ?></p>
<!-- /wp:paragraph -->
